...
```ruby
From: /Users/mluukkai/opetus/ratebeer/app/controllers/places_controller.rb @ line 11 PlacesController#search:

     9: def search
    10:   city = params[:city]
 => 11:   binding.pry
    12:   @places = BeermappingApi.places_in(city)
    13:   @weather = WeatherService.weather_for(city)
    14:   session['last_city'] = city
    15:
    16:   render :index
    17: end
...
=> {"utf8"=>"✓",
 "authenticity_token"=>
  "NLYbRDmwjOF1sJj1oGaEDbqiEwimxcDkcQL4WCUNVnhCbtm1GncIB0mWK/aESjlZ+pW62G6MQuE406JXgBpvmA==",
 "city"=>"helsinki",
 "commit"=>"Search",
 "controller"=>"places",
 "action"=>"search"}
...
=> #<Style:0x007fe652524c08
 ...
 created_at: Wed, 08 Feb 2017 16:30:32 UTC +00:00,
 updated_at: Wed, 08 Feb 2017 16:34:15 UTC +00:00>
```
